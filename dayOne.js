...
for (let i = 0; i < newArr.length; i++) {
    for (let j = 1; j < newArr.length; j++) {
        for (let k = 2; k < newArr.length; k++) {
            if (newArr[i] + newArr[j] + newArr[k] === 2020) {
                console.log('found!');
                sumArr.push(newArr[i]);
                sumArr.push(newArr[j]);
                sumArr.push(newArr[k]);
            }
        }
    }
    console.log('ran loop ' + i);
}

// for(let i = 0; i < newArr.length; i++){
//   for(let j = 1; j < newArr.length; j++){
//     if(newArr[i] + newArr[j] === 2020){
//       console.log('found!');
//       sumArr.push(newArr[i]);
//       sumArr.push(newArr[j]);
//     }
...
console.log('done!');
console.log(sumArr);
let sumanswer = sumArr[0] + sumArr[1] + sumArr[2];
console.log(sumanswer);
let answer = sumArr[0] * sumArr[1] * sumArr[2];
console.log(answer);
