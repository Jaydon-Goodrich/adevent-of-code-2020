...
//part 1
// function validateWord(min, max, letter, word) {
...
//     }
// }
function validateWord(posOne, posTwo, letter, word) {
    posOne = posOne - 1;
    posTwo = posTwo - 1;

    if (word[posOne] === letter && word[posTwo] === letter) {

        notValidCount++;
    }
    else if (word[posOne] === letter && word[posTwo] !== letter) {
        validCount++;
    }
    else if (word[posOne] !== letter && word[posTwo] === letter) {
        validCount++;
...
//     let thisString = oldArr[i];
//     let newString = thisString.split(' ');
//     let minMax = newString[0].split("-");
//     let min = minMax[0];
//     let max = minMax[1];
//     let letter = newString[1][0];
//     let word = newString[2];
//     validateWord(min, max, letter, word);
// }
for (let i = 0; i < oldArr.length; i++) {
    let thisString = oldArr[i];
    let newString = thisString.split(' ');
    ...
    let letter = newString[1][0];
    let word = newString[2];
    validateWord(posOne, posTwo, letter, word);
}
